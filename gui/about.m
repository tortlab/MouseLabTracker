...
% Last Modified by GUIDE v2.5 30-Jun-2011 14:27:19
...
img1 = imread(fullfile('gui', 'images', 'two_mice.png'));
img2 = imread(fullfile('gui', 'images', 'brain_institute_logo.png'));

imshow(img1, 'Parent', handles.axes1);
imshow(img2, 'Parent', handles.axes2);

set(handles.text16, 'String', Constants.VersionString);
